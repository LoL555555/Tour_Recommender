...
public static Population evolvePopulation(Population pop) {
    ...
    // Select parents (previous route)
        Tour parent1 = tournamentSelection(pop); Tour parent2 = tournamentSelection(pop); // Crossover parents
        Tour child = crossover(parent1, parent2); // Add offspring route to new population 
...
// Create new child route 
    ...
    // If our start position is less than the end position
        if (startPos < endPos && i > startPos && i < endPos) {
            child.setCity(i, parent1.getCity(i)); } // If our start position is larger
